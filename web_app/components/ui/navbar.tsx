...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 h-14 bg-black/90 backdrop-blur border-b border-white/10 flex items-center px-6 gap-6">
      <Link href="/" className="flex items-center gap-2 group" aria-label="Qaramia home">
        ...
        <svg viewBox="0 0 320 320" width="36" height="36" aria-hidden="true" className="transition-transform group-hover:scale-105">
          <defs>
            <linearGradient id="nav-ring" x1="15%" y1="0%" x2="85%" y2="100%">
          ...
          <circle cx="160" cy="160" r="98" fill="none" stroke="url(#nav-ring)" strokeWidth="26" strokeLinecap="round"/>
          <line x1="218" y1="218" x2="252" y2="252" stroke="url(#nav-ring)" strokeWidth="26" strokeLinecap="round"/>
          <path d="M 187 119 A 58 58 0 1 0 187 201" fill="none" stroke="url(#nav-c)" strokeWidth="26" strokeLinecap="round"/>
        </svg>
        <span
